...
'''
search_button = Button(mailerwindow, text="Search Customer by Last Name", font=('', 12), fg=fg, command=search_name, activebackground='blue', activeforeground='green')
search_button.place(x=160, y=10) # (x=128, y=80)
...
'''
# the send button
Button(mailerwindow, text="Send email", font=('', 12), fg=fg, command=send_mail, activebackground='blue', activeforeground='green').place(x=100, y=800)# x=100, y=600
