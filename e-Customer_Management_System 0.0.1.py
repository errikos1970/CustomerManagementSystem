...
changelog:
----------
* renamed project to e-Customer_Management_System and versioning to 0.0.1
* uploaded this file to git
* fixed the search in tabs
* fixed opening multiple tabs during multiple search
* beautified the code
...
'''  OLD MENUS
# Add a customer Search menu
customer_search_menu = Menu(menu, tearoff=0)
menu.add_cascade(label="Search", menu=customer_search_menu)
customer_search_menu.add_command(label="Search Customers", command=open_customer_search_window)

# Add a product Search menu
product_search_menu = Menu(menu, tearoff=0)
menu.add_cascade(label="Search", menu=product_search_menu)
product_search_menu.add_command(label="Search Products", command=open_product_search_window)
'''
...
q1 = tk.StringVar()
q2 = tk.StringVar()
#  EDO DES q_customers = tk.StringVar()
#  EDO DES q_products = tk.StringVar()
t1 = tk.StringVar()
t2 = tk.StringVar()
t3 = tk.StringVar()
t4 = tk.StringVar()
...
# wrapper1 = ttk.LabelFrame(mainwindow, text="Search Database") #commented on 06.7.3
...
#wrapper6 = ttk.LabelFrame(mainwindow, text="Search Database")
...
trv_customers.pack(side=LEFT)#added on 4.03 for the scrollbar
trv_customers.place(x=0, y=0) #added on 4.03 to show the scrollbar original: trv.place(x=0, y=0)
...
# add double click,to update fields
