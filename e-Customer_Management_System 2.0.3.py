'''
e-Customer_Management_System Version: 2.0.3
Date: 05/06/2024
...
changelog:
----------
* Fixed auto clear fields after add customers or products
...
mainwindow = tk.Tk()
mainwindow.title("Customer Management System 2.0.3")
...
# TEST BLOCK 28-5-24
def mail_me():
    # Replace 'script_to_run.py' with your actual script filename
