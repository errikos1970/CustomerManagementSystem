'''
e-Customer_Management_System Version: 0.0.8
Date: 06/05/2024
...
mainwindow = tk.Tk()
mainwindow.title("Customer Management System 0.0.8")
...
mydb = sqlite3.connect('crmdatabase009.db')
cursor = mydb.cursor()
